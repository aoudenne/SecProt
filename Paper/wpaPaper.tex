...
forall p:principal, n:bitstring; 
	c(msg1(n,p))->c(msg2(nSTA[STA[],p], 
		maic(nSTA[STA[], p], makePTK(n, 
			nSTA[STA[],p],p, STA[], PMK[]))));
\end{verbatimtab}
\item
\begin{verbatimtab}[2]
forall p:principal, n:bitstring; 
	c(msg2(n,maic(n, makePTK(nAP[p],n, AP[],
		p, PMK[])))) -> c(msg3(encrypt(GTK[], 
				makePTK(nAP[p],n,AP[],p,PMK[]))));
\end{verbatimtab}
\item
\begin{verbatimtab}[2]
forall p:principal, n:bitstring; 
...
We then define an invariant that must hold if this protocol is to be considered secure.  Security is leaked if the 
