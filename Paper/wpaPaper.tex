...
Unfortunately, it is not enough to only provide authentication and confidentiality.  Much of today's business transactions are conducted electronically, and companies cannot afford a Denial of Service attack. For this reason, 802.11i needs to be modified.  Changhua He et al. claim that their solution of nonce reuse has been adopted by the 802.11i standards committee \cite{heMitchell05}.  
